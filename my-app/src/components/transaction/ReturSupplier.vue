  ...
  <div class="container">
    <form @submit.prevent="addToCart" class="receipt-form">
      <div class="form-header">
        <h3>Retur Barang To Supllier</h3>
    ...
    <ReturDocView v-if="showReturDoc" :receipt="submitReceiptData" :dialog="dialog" />
  </div>
</template>
...
import ReturDocView from '../print/ReturDocView.vue';

export default {
    components: { ReturDocView },
    data() {
        return {
            receipt: {
                itemName: '',
    ...
    methods: {
        ...
        async submitReceipt() {
            ...
            // });
                ...
                const response = await api.post('/t_retur_receipt', {
                ...
                this.noRetur = response.data.no_retur;
                this.kodeRetur = this.noRetur;
                console.log('noRetur:', this.noRetur);
                console.log('kodeRetur:', this.kodeRetur);
                console.log('tanggal:', this.receipt.tanggal)

                alert('Data berhasil disimpan');
                this.submitReceiptData = {
                    kodeRetur: this.noRetur, // Use no_retur for kodeRetur
                    kodeSupplier: this.receipt.kodeSupplier,
